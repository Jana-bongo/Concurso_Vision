...
app = Flask(__name__)
app.secret_key = 'sua_chave_secreta_aqui_mude_isso'  # MUDE ISSO!
...
def adicionar_concurso():
    ...
    if request.method == 'POST':
        ...
        vagas = request.form['vagas'] if request.form['vagas'] else None
        escolaridade = request.form['escolaridade'] if request.form['escolaridade'] else None
        status = request.form['status']
        link_edital = request.form.get('link_edital', '')
        data_inscricao_inicio = request.form.get('data_inscricao_inicio') if request.form.get('data_inscricao_inicio') else None
        data_inscricao_fim = request.form.get('data_inscricao_fim') if request.form.get('data_inscricao_fim') else None
        data_prova = request.form.get('data_prova') if request.form.get('data_prova') else None
